LevelManager.levels.level3 = function() {
  ...
  //----------------//------Platform----//----------------//--------------
  walls.push(new Component(200, 50, "#21FFB6", 1800, 1050));//small dots left

  walls.push(new Component(200, 50, "#21FFB6", 2300, 1050)); //small dots right


  walls.push(new Component(400, 40, "#21FFB6", 1200, 1260));//platform left

  walls.push(new Component(400, 40, "#21FFB6", 2600, 1260));//platform right
  //----------------//----------------//----------------//----------------
